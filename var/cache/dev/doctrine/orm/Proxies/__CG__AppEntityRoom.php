...
class Room extends \App\Entity\Room implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'roomReservation' => [parent::class, 'roomReservation', null],
        ...
        'roomReservation' => [parent::class, 'roomReservation', null],
    ...
    public function __construct(?\Closure $initializer = null)
    {
        self::createLazyGhost($initializer, [
            ...
            "\0".parent::class."\0".'roomReservation' => true,
            '__isCloning' => true,
        ], $this);
    }
